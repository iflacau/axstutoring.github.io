...
function Tutoring()
{
    ...
    function checkInputs()
    {
        ...
        if (!email.includes("@ucla.edu") && !email.includes("@g.ucla.edu"))
        {
            setCheckEmail(true);
    ...
    function nameNotification()
    {
        if (checkName)
        {
            return <div><p1>Name</p1> <p1 class="redColor">(Invalid Name)</p1></div>
        }
        else
        {
            return <p1>Name</p1>
    ...
    function emailNotification()
    {
        if (checkEmail)
        {
            return <div><p1>Email</p1> <p1 class="redColor">(Invalid UCLA email)</p1></div>
        }
        else
        {
            return <p1>Email</p1>
    ...
    function bookingNotification()
    {
        ...
        {
            case 2:
                return <p1 class="alignCenter">Cannot exceed four appointments per month</p1>
            case 3:
                return <p1 class="alignCenter">Cannot exceed two appointments per week</p1>
            default:
                return <div></div>
        }
    }
            ...
            return (
                <>
                    ...
                    <div className="container">
                        <a href="https://kevintangprogram.github.io/axs"><img id="homeImage" src="coat.png" height="163.5" width="150" alt="CoatOfArms"/></a>
                    </div>
            ...
            return (
                <>
                    ...
                    <div className="selectGrid">
                        ...
                        For more information, please contact Arthur Huang and Claire Luong at tutoring.axsbg@gmail.com.
                        </p1>
                    </div>
                </>
            )
                ...
                <>
                    ...
                    <div className="selectGrid">
                        <p1 className="alignCenter">Maximum of two appointments per week or four booking per month with each appointment being one hour. 
                            ...
                            <br></br><br></br><br></br>
                            For other inquiries, please contact Arthur Huang and Claire Luong at tutoring.axsbg@gmail.com.
                            </p1>
                    </div>
                </>
            )
